...
abstract class AbstractLiveTemplatesTest : NewLightKotlinCodeInsightFixtureTestCase() {
    ...
    fun testSoutv() {
        ...
        assertStringItemsFromDirective()
    ...
    protected open val itemsDirective: String = "ITEMS"

    private fun assertStringItemsFromDirective() {
        val items =
            InTextDirectivesUtils.findListWithPrefixes(myFixture.file.text, itemsDirective)
        assertStringItems(*items.toTypedArray())
    }
